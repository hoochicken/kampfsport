# Einleitung & Gesetzlage

## Rechtliche Grundlagen

**Selbstverteidigung in Deutschland** ist unter bestimmten Voraussetzungen erlaubt. Die wichtigsten Grundlagen sind die Notwehr (§ 32 StGB) und die Nothilfe (§ 32 StGB).

**Notwehr**: Notwehr ist die Verteidigung gegen einen gegenwärtigen rechtswidrigen Angriff auf die eigene Person oder auf eigene Rechtsgüter. Ein Angriff ist gegenwärtig, wenn er unmittelbar bevorsteht, gerade stattfindet oder noch andauert.

**Beispiel:** Eine Person schlägt nach dir. Du blockst den Angriff und stößt die Person weg. Dies ist Notwehr.

**Nothilfe** : Nothilfe ist Notwehr zugunsten einer anderen Person.

**Beispiel:** Du beobachtest, wie eine Person angegriffen wird. Du greifst ein und verhinderst weitere Schläge. Dies ist Nothilfe.

**Nicht gegenwärtiger Angriff** Ist der Angriff beendet, endet auch das Notwehrrecht.

**Beispiel:** Eine Person schlägt dich und läuft anschließend davon. Verfolgst du die Person und greifst sie später an, handelt es sich nicht mehr um Notwehr.

**Verhältnismäßigkeit und Notwehrüberschreitung**: Das deutsche Notwehrrecht verlangt grundsätzlich keine Verhältnismäßigkeitsprüfung wie in anderen Rechtsgebieten. Die Verteidigung muss jedoch erforderlich sein, um den Angriff zu beenden.

**Beispiel:** Jemand beleidigt dich. Du schlägst ihn daraufhin bewusstlos. Eine solche Reaktion kann als Notwehrüberschreitung gewertet werden.

Es gilt also: „Verteidigung ja – Vergeltung nein.“
...
* **Eigensicherung!:** DEINE SICHERHEIT hat HÖCHSTE PRIORITÄT.
    * ist die Umgebung sicher? (kann nichts auf dich runterfallen oder verbrennen)
    * befinden sich noch Aggressoren vor Ort?
    * Hast Du Latex-Handschuhe, um Dich vor eventuell infiziertem Blut zu schützen?
...
## Biologische Grundsätze

Dein Körper passt auf dich auf.

Seit Millionen von Jahren laufen in unserem Körper Programme ab, die unserem Überleben dienen. Die Tatsache, dass du heute hier bist, zeigt, dass diese Mechanismen bei deinen Vorfahren funktioniert haben.

Der Körper verfügt über verschiedene Reaktionen auf Gefahr. Diese werden automatisch aktiviert, wenn eine Situation als bedrohlich eingeschätzt wird.
...
Keine dieser Reaktionen ist grundsätzlich richtig oder falsch. Sie dienen alle demselben Ziel:
