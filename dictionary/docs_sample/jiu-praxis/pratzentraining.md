...
beim bratzentraining gibt es im Großen und Ganzen zwei attanten, drei, wenn du den Trainer (dich). was dich als Trainer angeht, so findest Du bratzentraining auch in der Trainingslehre sieht dort nach. für die verbliebenen beiden anderen Gruppen lies genau hier:

## pratzenschläger*in

der pratzenschläger ist derjenige oder diejenige, die auf die Katze einschlagen. gerne hätte ich dafür ein anderes Wort genommen, aber mir ist keines eingefallen. 
...
ein weit verbreitetes Missverständnis ist es, dass du als Katzenhalter eigentlich gar nicht trainierst, sondern das nur der andere gerade trainieren. mit diesem Vorteil möchte ich hiermit ein für alle Mal ausräumen. kratzen halten ist so ziemlich die beste Schulung, die du überhaupt kriegen kannst als Training . 

schon mal vorab: im Großen und Ganzen trainierst du zwei Aspekte: erstens du lernst dein Auge für dein Gegenüber zu bekommen, für deinen Partner. und für die Technik. dir in irgendeiner Weise durch Aktion ankündigt zum zweiten trainierst du wie es ist, ein optimaler Trainer zu sein

die folgende Aufzählung enthält alle die Punkte, die du während des Katzen?:-DHaltens trainierst

**memorierung**: in der Regel werden Kombinationen trainiert. diese Kombinationen musst du memorieren, das heißt sie dir einprägen innerhalb kürzester Zeit und die Pratzen korrekt dafür halten. (eine zusätzliche Herausforderung ist es, dich gleichzeitig auf einen Rechtsausleger einzustellen)
...
* positionierung: wie effektiv steht der partner im raum? wie kann er die technik anwenden? steht er zu weit weg oder zu nah? stimmt der winkel?
* distanzierung der techniken: inwieweit führt er die technik optimal aus, ist z. b. der arm noch sehr angewinkelt, obwohl es eigentlich ein laanger gerader schlag sein sollte?
* beinarbeit: wechselt er die position effektiv oder schneckt er herum? wie kann er seine geschwindigkeit verbesseen?
...
**Verletzung durch schlagimpakt**: Paradebeispiel ist hier der **Lowkick**. hier kommt es massiv auf die Beinstellung an (Knie muss unbedingt gebeugt sein!), um Gegenkraft geben zu können. dies ist unbedingt erforderlich um keinen Schaden zu nehmen 

weiteres Paradebeispiel ist ein **Haken** oder **roundhouse Kick** oder **back roundhouse Kick**. oft muss die Bratze hierfür rechtwinklig gehalten werden und die Schulter muss entsprechend nachgeben bei ihm Punkt dies kann zur Schulterverletzung führen. denn die Schlagbewegung führt in die Belastungsrichtung der Schulter hinein Tipp im stattdessen die andere Hand um die Bratze zu halten
